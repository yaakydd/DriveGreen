export const knowledgeBase = [
  ...
  {
    keywords: ["hello", "hi there", "hey", "greetings", "good morning", "good afternoon", "howdy"],
    priority: 10,
  ...
  {
    keywords: ["government doing", "government policy", "regulations", "government action", "policy"],
    priority: 9,
  ...
  {
    keywords: ["tax incentive", "rebate", "tax credit", "subsidy", "government incentive"],
    priority: 9,
  ...
  {
    keywords: ["how calculate", "how predict", "formula", "algorithm", "math behind", "xgboost", "model work", "science behind"],
    priority: 10,
    response: "**The Science Behind Your Score:** I use three inputs: fuel type, engine size, and number of cylinders to estimate emissions. XGBoost is the trained model used for prediction. **The process:** Numeric features (engine size, cylinders) are log-transformed before training, and categorical features (fuel type) are one-hot encoded. They're combined in one dataframe to train the model. After prediction, the log-transformed results are reversed to get the actual CO2 emissions."
  },
  
  {
    keywords: ["accurate", "trust", "precise", "reliability", "exact", "reliable", "confidence", "how accurate"],
    priority: 10,
  ...
  {
    keywords: ["color code", "what do colors mean", "red green yellow", "orange rating", "color guide"],
    priority: 10,
  ...
  // APP FUNCTIONALITY
  {
    keywords: ["how does website work", "how does app work", "how does this work", "what is purpose", "what does this do"],
    priority: 9,
  ...
  // REDUCTION TIPS (General - comes after specific queries)
  {
    keywords: ["how to reduce", "how to lower", "reduction tips", "how improve", "how to decrease", "cut emissions"],
    priority: 8,
  ...
  // DATA SOURCES
  {
    keywords: ["data source", "where from", "database", "where information", "data come from"],
    priority: 8,
  ...
  // VEHICLE SPECIFICS
  {
    keywords: ["old car", "vintage", "classic car", "year model", "old vehicle"],
    priority: 8,
  ...
  {
    keywords: ["annual mileage", "how many km", "distance drive", "miles per year"],
    priority: 8,
  ...
  // FUEL TYPES
  {
    keywords: ["fuel type", "gasoline vs diesel", "petrol", "cng", "lpg", "ethanol", "e85", "fuel comparison"],
    priority: 8,
    response: "**Fuel Carbon Intensity (gCO2e/MJ):** Gasoline: ~95, Diesel: ~95 (but more energy-dense), CNG: ~70, E85 (Corn): ~75 (controversial due to land use), Electricity: Varies from **0 to 150** based on your local grid's renewable mix. Diesel has higher NOx & PM; CNG has lower CO2."
  },
  
  {
    keywords: ["electric car", "ev", "tesla", "zero emission", "plug-in electric", "battery car"],
    priority: 9,
  ...
  {
    keywords: ["hybrid car", "prius", "mild hybrid", "phev", "plug-in hybrid"],
    priority: 8,
  ...
  {
    keywords: ["hydrogen fuel", "fuel cell", "fcev", "h2 car"],
    priority: 8,
    response: "Hydrogen fuel cell vehicles emit only water vapor. But the **'Well-to-Wheels'** story is key. 'Green' hydrogen from renewables is clean; 'Grey' hydrogen from natural gas can have a higher footprint than diesel. The infrastructure is still limited."
  },

  // HEALTH IMPACT
  {
    keywords: ["health impact", "lung disease", "asthma", "cancer risk", "sick", "disease", "medical"],
    priority: 8,
  ...
  {
    keywords: ["children health", "kids", "school pollution", "playground"],
    priority: 8,
  ...
  {
    keywords: ["noise pollution", "sound pollution", "quiet car", "loud car"],
    priority: 7,
  ...
  {
    keywords: ["city pollution", "urban smog", "air quality", "smog"],
    priority: 8,
  ...
  {
    keywords: ["environmental justice", "inequality", "poor communities", "fair", "equity"],
    priority: 7,
  ...
  {
    keywords: ["global warming", "climate change", "extreme weather", "flood", "fire", "sea level"],
    priority: 8,
  ...
  // MONEY & COSTS
  {
    keywords: ["save money", "fuel cost", "expensive", "cheap", "fuel economy", "mpg", "financial savings"],
    priority: 9,
  ...
  {
    keywords: ["resale value", "depreciation", "sell car", "trade-in"],
    priority: 7,
  ...
  {
    keywords: ["insurance cost", "ev insurance"],
    priority: 7,
  ...
  {
    keywords: ["bike", "walk", "public transit", "bus", "train", "telecommute", "car-free"],
    priority: 8,
  ...
  {
    keywords: ["work from home", "commute", "remote work", "office"],
    priority: 7,
  ...
  {
    keywords: ["vacation travel", "road trip", "fly vs drive", "airplane"],
    priority: 7,
  ...
  {
    keywords: ["home solar", "solar panel", "home energy"],
    priority: 7,
  ...
  {
    keywords: ["buy next car", "car shopping", "recommend car", "what car", "which car"],
    priority: 8,
  ...
  {
    keywords: ["future cars", "2030", "2040", "gas ban", "ice ban"],
    priority: 7,
  ...
  {
    keywords: ["individual action", "hope", "optimistic", "despair", "helpless", "make difference"],
    priority: 7,
  ...
  {
    keywords: ["large suv", "big truck", "hummer", "worst vehicle"],
    priority: 7,
  ...
  {
    keywords: ["carbon offset", "plant tree", "compensate", "offset emissions"],
    priority: 7,
  ...
  {
    keywords: ["battery mining", "lithium", "ev battery", "mining impact", "dirty battery"],
    priority: 7,
  ...
  {
    keywords: ["convince friends", "family", "share", "talk about"],
    priority: 6,
  ...
  {
    keywords: ["feel guilty", "shame", "feel bad", "guilty"],
    priority: 6,
  ...
  {
    keywords: ["help me", "assist", "support", "guide"],
    priority: 2,
